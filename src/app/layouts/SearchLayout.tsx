...
//     <div >
//       <Navbar />
//       <div className="h-screen flex flex-col border border-solid border-gray-300 bg-gray-50">
//         <div className="border-b">
//           <LocationSearch />
//         </div>

//         <div className="flex-[8] flex w-full overflow-hidden">
//           <aside className="lg:w-1/5 lg:pt-1  pl-4 ">
//             <FilterSlideBar loading={loading} error={error} />
//           </aside>
//           <main
//             ref={mainRef}
//             className="w-full lg:w-4/5  h-full overflow-y-auto flex flex-col "
//           >
//             <ProductList
